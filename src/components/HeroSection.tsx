      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-3xl">
          <div className="inline-flex items-center gap-2 rounded-full border border-accent/30 bg-accent/10 px-4 py-1.5 mb-8">
            ...
            <span className="text-sm font-medium text-accent">HR Strategy & Compliance Experts</span>
          </div>
          ...
          <p className="text-lg md:text-xl text-muted-foreground max-w-xl mb-10 leading-relaxed">
            Full-service HR consulting to help your business attract, develop, and retain top talent — while staying compliant and competitive.
          </p>
